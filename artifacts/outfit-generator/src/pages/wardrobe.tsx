...
const ROWS: { key: RowKey; label: string; btnLabel: string }[] = [
  { key: "outfits",    label: "+ Add Tools",    btnLabel: "+ ADD TOOLS"    },
  { key: "beauty",     label: "+ Add Parts",    btnLabel: "+ ADD PARTS"    },
  { key: "toiletries", label: "+ Add Vehicles", btnLabel: "+ ADD VEHICLES" },
  { key: "essentials", label: "+ Add Storage",  btnLabel: "+ ADD STORAGE"  },
];
        ...
        <>
          ...
          {itemsLeft !== null && (
            <button
              ...
              style={{
                position: "absolute",
                top: pY(ir, 0.093), left: "50%", transform: "translateX(-50%)",
                zIndex: 25,
                border: "none", background: "none", padding: 0,
                color: totalItems >= FREE_ITEM_LIMIT ? "#ff6060" : "#F0F0F0",
          ...
          {ROWS.map(({ key, btnLabel }, rowIdx) => {
            ...
            const labelYOffsets = [0.055, -0.026, -0.012, -0.012];
              ...
              <React.Fragment key={key}>
                ...
                {items.length > 0 && (
                  <div
                    ...
                    style={{
                      position: "absolute",
                      top:    Math.max(secTop, labelY + pH(ir, 0.032)),
                      left:   carLeft,
                      width:  carW,
