# App Store Submission Guide — My Digital Garage
...
3. Fill in:
   - Platform: iOS
   - Name: **My Digital Garage**
   - Primary Language: English (U.S.)
   - Bundle ID: **com.mydigitalgarage.app** *(you'll need to register this in your Developer account first)*
...
3. Bundle ID: `com.mydigitalgarage.app`
...
- [ ] In-App Purchase created in App Store Connect (Product ID: `com.mydigitalgarage.app.premium`)
...
→ Register `com.mydigitalgarage.app` in your Apple Developer account (Step 3)
